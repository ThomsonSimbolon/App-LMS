    ...
    <div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="card p-6">
            <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-4">Recent Enrollments</h3>
            <div className="text-sm text-neutral-500 italic">No recent enrollments to show.</div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="card p-6">
             <h3 className="text-lg font-bold text-neutral-900 dark:text-white mb-4">Instructor Tips</h3>
