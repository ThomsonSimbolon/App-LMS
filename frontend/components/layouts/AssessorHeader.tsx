      ...
      <div className="flex h-full items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center">
          <button
            ...
            className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-slate-700 dark:text-slate-300"
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg"
          >
            <User className="w-4 h-4" />
            <span>Profile</span>
          </button>
